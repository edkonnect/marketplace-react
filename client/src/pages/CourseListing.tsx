...
export default function CourseListing() {
  ...
  const [testPrepGroupFilter, setTestPrepGroupFilter] = useState<string>(params.get("testPrepGroup") ?? "all");
  ...
  useEffect(() => {
    ...
    setCategoryFilter(p.get("category") ?? "all");
    setTestPrepGroupFilter(p.get("testPrepGroup") ?? "all");
    setCurrentPage(1);
  }, [search]);
  ...
  const filteredCourses = courses
    ...
    .sort((a, b) => {
      ...
      // Default: sort by sheet order (matches xlsx tab order exactly)
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              <Select
                ...
                onValueChange={(v) => {
                  setCategoryFilter(v);
                  if (v !== "Test Prep") setTestPrepGroupFilter("all");
                  setCurrentPage(1);
                }}
              >
